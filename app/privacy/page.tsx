...
export const metadata: Metadata = {
  title: 'Privacy Policy - NeuraPress',
  description: 'Learn how NeuraPress protects your privacy and handles your data.',
};
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-700">
                <strong>Email:</strong> privacy@neurapress.com<br />
