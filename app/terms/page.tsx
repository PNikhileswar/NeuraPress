...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using the TrendWise platform.',
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              Terms and conditions for using the TrendWise platform.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto prose prose-lg">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 mb-6">
              ...
              TrendWise for personal, non-commercial transitory viewing only. This is the 
              grant of a license, not a transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              <li>Modify or copy the materials</li>
              <li>Use the materials for any commercial purpose or for any public display</li>
              <li>Attempt to reverse engineer any software contained on TrendWise</li>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>TrendWise may moderate, edit, or remove content at its discretion</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Intellectual Property</h2>
            <p className="text-gray-700 mb-6">
              The service and its original content, features, and functionality are and will 
              remain the exclusive property of TrendWise and its licensors. The service is 
            ...
            <p className="text-gray-700 mb-6">
              ...
              extent permitted by law, TrendWise excludes all representations, warranties, 
            ...
            <p className="text-gray-700 mb-6">
              In no event shall TrendWise or its suppliers be liable for any damages 
              (including, without limitation, damages for loss of data or profit, or due to 
              business interruption) arising out of the use or inability to use the materials 
              on TrendWise, even if TrendWise or an authorized representative has been 
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-700">
                <strong>Email:</strong> legal@trendwise.com<br />
