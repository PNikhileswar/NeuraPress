        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-50 rounded-lg p-4 text-center">
              ...
              <div className="text-sm text-blue-700 mb-2">Visual Assets</div>
            ...
            <div className="bg-green-50 rounded-lg p-4 text-center">
              ...
              <div className="text-sm text-green-700 mb-2">This Week</div>
              <div className="text-xs text-gray-600">
                {stats.performance.avgArticlesPerDay} daily average
              </div>
            </div>
            <div className="bg-orange-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-orange-600 mb-1">
                {Math.round(stats.overview.avgReadingTime)}m
              </div>
              <div className="text-sm text-orange-700 mb-2">Avg Reading Time</div>
              <div className="text-xs text-gray-600">
                {Math.round(stats.overview.totalReadingTime / 60)}h total content
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-600">With Visuals</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-semibold text-blue-600">
                  {stats.overview.featuredArticles}
                </div>
                <div className="text-xs text-gray-600">Featured Articles</div>
              </div>
              <div className="text-center">
